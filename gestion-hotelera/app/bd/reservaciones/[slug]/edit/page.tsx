        ...
        const cargarReserva = async () => {
            try {
                if (!isNaN(idNumero)) {
                    ...
                    setSaldoPendiente(data!.total_pagar! - data!.monto_pagado!);
                }
            } catch (error) {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="pt-3 border-t border-slate-100">
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="text-lg font-black text-red-600">L. {saldoPendiente.toLocaleString('es-HN')}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                {saldoPendiente > 0 ?
                    (
                        ...
                        <div>
                            <span className="material-symbols-outlined">check_circle</span>
                            <p className="text-sm font-medium">Pago Completo</p>
                        </div>
                    )
                }
                    ...
                    <table className="min-w-full text-sm">
                        ...
                        <tbody className="divide-y divide-slate-50">
                            <tr className="hover:bg-slate-50/50 transition-colors">
                                {reserva.map((pago: any) => (
                                    <tr key={pago.id}>
                                        <td className="px-6 py-4 text-slate-600">{pago.fecha}</td>
                                        <td className="px-6 py-4 text-slate-600 font-medium">{pago.metodo}</td>
                                        <td className="px-6 py-4 font-bold text-emerald-600">{pago.monto_pagado}</td>
