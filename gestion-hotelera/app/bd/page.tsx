                    ...
                    <div className="flex justify-between items-center mb-6 pb-4 border-b border-slate-300 card-shadow ">
                        ...
                        <div className="flex gap-4">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-[12px] leading-3.5 font-medium text-[#515f74]">Limpia</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="w-3 h-3 rounded-full bg-slate-400"></span>
                                <span className="text-[12px] leading-3.5 font-medium text-[#515f74]">Ocupada</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="w-3 h-3 rounded-full bg-amber-500"></span>
                                <span className="text-[12px] leading-3.5 font-medium text-[#515f74]">Sucio</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="w-3 h-3 rounded-full bg-rose-500"></span>
                                <span className="text-[12px] leading-3.5 font-medium text-[#515f74]">Mantenimiento</span>
                            </div>
                        </div>
                    </div>

                    <div className="grid grid-cols-6 md:grid-cols-10 gap-2 flex-1">
                        <div className="aspect-square border-t-4 border-emerald-500 bg-[#f7f9fb] flex items-center justify-center rounded-sm text-[12px] leading-3.5 font-medium text-[#515f74] cursor-pointer hover:bg-[#e0e3e5] transition-colors">101</div>
                ...
                <div className="col-span-12 lg:col-span-4 bg-[#ffffff] border border-slate-300 card-shadow  rounded-xl p-6 shadow-level-1 flex flex-col">
                    ...
                    <div className="flex-1 flex items-end gap-2 mt-4 pt-4 border-t border-slate-300 card-shadow  h-50">
                        <div className="flex-1 flex flex-col items-center gap-2">
                            ...
                            <span className="text-[12px] leading-3.5 font-medium text-[#515f74]">Lun</span>
                        </div>
                        <div className="flex-1 flex flex-col items-center gap-2">
                            <div className="w-full bg-[#bec6e0] rounded-t-sm h-[75%] hover:bg-[#131b2e] transition-colors cursor-pointer"></div>
                            <span className="text-[12px] leading-3.5 font-medium text-[#515f74]">Mar</span>
                        </div>
                        <div className="flex-1 flex flex-col items-center gap-2">
