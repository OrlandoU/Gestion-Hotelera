        ...
        <>
            ...
            <div className="flex-1 flex flex-col gap-6 w-full">
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    ...
                    <div className="bg-white rounded-xl border border-slate-300 card-shadow p-6 flex flex-col justify-between">
                        <h3 className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Productos agotados</h3>
                        <div className="flex items-baseline gap-2 my-auto">
                            <span className="text-3xl font-bold text-red-600">{resumen.agotados}</span>
                            <span className="text-xs text-slate-500">ítems en 0</span>
                        </div>
                        <p className="text-xs text-slate-500">Requieren reabastecimiento inmediato.</p>
                    </div>
