        ...
        <header className="sticky top-0 z-40 w-full bg-[#ffffff] border-b border-slate-300 card-shadow  shadow-sm flex justify-between items-center px-10 py-2">
            <div className="flex items-center gap-6">
                <div className="relative group">
                    ...
                    <input readOnly className="pl-10 pr-6 py-2 bg-[#f2f4f6] border-none rounded-full text-[14px] leading-5 font-normal font-['Hanken_Grotesk'] w-64 focus:ring-2 focus:ring-[#008cc7] transition-all" placeholder="Buscar facturas..." type="text" />
                </div>
            </div>
            <div className="flex items-center gap-6">
